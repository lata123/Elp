...
class OneSignalClient
{
    ...
    public function sendNotificationToUser($message, $userId, $config, $url = null, $data = null, $buttons = null, $schedule = null, $headings = null, $subtitle = null) {
        $contents = array(
            "en" => $message
        );
        $this->appId = $config['app_id'];
        $this->restApiKey = $config['secret'];
        $params = array(
            'app_id' => $this->appId,
            'contents' => $contents,
